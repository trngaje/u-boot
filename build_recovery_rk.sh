...
pack_spi_full_image()
{
	...
	dd if=./arch/arm/dts/odroidgo2-kernel-rk.dtb of=${OUT}/spi_recovery.img bs=512 seek=8192 count=200 conv=fsync,notrunc
...
#	sudo cp ./arch/arm/dts/odroidgo2-kernel.dtb ${MNT}/rk3326-odroidgo2-linux.dtb
	sudo cp ./arch/arm/dts/odroidgo2-kernel-rk.dtb ${MNT}/rk3326-odroidgo2-linux.dtb
